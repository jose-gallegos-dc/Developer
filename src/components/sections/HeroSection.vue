...
<template>
  <section id="inicio" class="hero-section min-h-screen pt-16 flex items-center relative overflow-hidden">
    <div class="max-w-6xl mx-auto px-6 py-16 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center w-full">
      ...
      <!-- Foto — orden 1 en móvil, orden 2 en desktop -->
      <div class="order-1 lg:order-2 flex justify-center">
        <div class="relative">
          ...
          <!-- Foto -->
          <img
            src="/img/jose_gallegos.png"
            alt="José Gallegos"
            class="relative w-52 h-52 sm:w-64 sm:h-64 lg:w-80 lg:h-80 rounded-full object-cover object-top border-2 border-slate-700"
          />
        </div>
      </div>

      <!-- Texto — orden 2 en móvil, orden 1 en desktop -->
      <div class="order-2 lg:order-1 space-y-7 text-center lg:text-left">

        <div>
          <p class="text-slate-400 text-base font-light tracking-wide mb-1">
            Hola, soy
          </p>
        ...
        <p class="text-slate-400 text-base leading-relaxed max-w-md mx-auto lg:mx-0">
          ...
          Si tienes un proyecto en mente, <span class="text-cyan-400 font-medium">construyámoslo juntos</span>.
        </p>

        <div class="flex items-center gap-5 justify-center lg:justify-start">
          <a
            href="#-"
            class="inline-flex items-center gap-2 border border-slate-500 text-slate-200 font-medium px-5 py-2.5 rounded-full hover:border-cyan-400 hover:text-cyan-400 transition-colors duration-200 text-sm"
          >
          ...
          <div class="flex items-center gap-4">
            <a href="#-" aria-label="LinkedIn" class="text-slate-500 hover:text-cyan-400 transition-colors">
              <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
              </svg>
            </a>
            <a href="#-" aria-label="GitHub" class="text-slate-500 hover:text-cyan-400 transition-colors">
              <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
